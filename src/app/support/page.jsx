  ...
  return (
    <div className='flex items-center justify-center min-h-screen bg-[#f9f9f9] px-4'>
      <div className='bg-white p-8 rounded-2xl shadow-lg max-w-2xl w-full text-center'>
        ...
        <h1 className='text-3xl font-bold text-[#333] mb-3'>Trung tâm hỗ trợ</h1>
        <p className='text-gray-600 mb-6'>
          Chúng tôi luôn sẵn sàng hỗ trợ bạn. Nếu bạn gặp bất kỳ sự cố nào liên quan đến tài khoản hoặc dịch vụ, vui
          lòng liên hệ với chúng tôi qua các kênh sau:
        </p>
