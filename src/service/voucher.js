...
export const getAllVoucher = async (storeId) => {
  try {
    ...
    console.log("Get all voucher: ", res);
    return res.data;
  } catch (error) {
...
export const addVoucher = async (storeId, voucherData) => {
  try {
    const res = await axios.post(
      `/voucher/stores/${storeId}/vouchers`,
      voucherData
    );
    return res.data;
  } catch (error) {
...
export const updateVoucher = async (storeId, voucherId, data) => {
  try {
    const res = await axios.put(
      `/voucher/stores/${storeId}/vouchers/${voucherId}`,
      data
    );
    return res.data;
  } catch (error) {
...
export const toggleVoucherActive = async (storeId, voucherId) => {
  try {
    const res = await axios.patch(
      `/voucher/stores/${storeId}/vouchers/${voucherId}/toggle-active`
    );
    return res.data;
  } catch (error) {
    return (
      error.response?.data || { status: "error", message: "Toggle failed" }
    );
  }
};
