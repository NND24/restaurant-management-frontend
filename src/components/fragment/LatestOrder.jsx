...
const LatestOrder = ({ order }) => {
    ...
    // (Optional) if you want to recompute totals client-side for display sanity
    ...
    return (
        <>
            ...
            Khách ghi chú: <span className="font-semibold">Không có ghi chú</span>
          </div> */}
                    ...
                    {/* Order Items (shows toppings + line totals) */}
                    <div className="bg-white p-4 rounded-lg shadow-md mb-4">
                        ...
                        <span className="text-xs text-gray-500">Thành tiền (bao gồm topping)</span>
                        <span className="text-[#fc6011] font-semibold">{formatVND(lineTotal)}</span>
                      </div> */}
                                    </li>
                                );
                            })}
                        ...
                        {/* Order Summary (use server totals or computed for display) */}
                        <div className="text-sm">
                            ...
                            <div className="flex justify-between mb-2">
                                ...
                                {/* show server subtotal if you trust it; computed.subtotal is just for visual cross-check */}
                                <span className="text-gray-800 font-medium">
                                    {formatVND(
                                        order?.subtotalPrice ??
                                            computed.subtotal
