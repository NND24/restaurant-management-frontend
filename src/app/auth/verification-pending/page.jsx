  ...
  return (
    <div className='flex items-center justify-center h-screen bg-[#f9f9f9] px-4'>
      <div className='bg-white p-8 rounded-2xl shadow-lg max-w-xl text-center'>
        ...
        <h2 className='text-2xl font-semibold text-[#333] mb-3'>Cửa hàng của bạn đang chờ xác minh</h2>
        ...
        <button disabled className='bg-gray-300 text-gray-600 px-6 py-3 rounded-full font-medium cursor-not-allowed'>
          Đang chờ xác minh...
        </button>
      </div>
    </div>
