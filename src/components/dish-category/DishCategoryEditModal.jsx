...
import { getCategoryById, updateDishCategory } from "@/service/dishCategory";
import { toast } from "react-toastify";

const DishCategoryEditModal = ({ open, onClose, id, onUpdated }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      setLoading(true);
      await updateDishCategory({ id, data: formData });
      onUpdated();
      onClose();
    } catch (err) {
...
export default DishCategoryEditModal;
