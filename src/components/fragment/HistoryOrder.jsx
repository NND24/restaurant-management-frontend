...
const HistoryOrder = ({ order }) => {
    ...
    return (
        <div className="w-full px-4 py-2 mt-20 mb-20">
          ...
          Khách ghi chú: <span className="font-semibold">{order?.notes || "Không có ghi chú"}</span>
        </div> */}
                    ...
                    <div className="flex items-center">
                      ...
                      />
                        ...
                        <div className="ml-3">
                            ...
                            <p className="text-sm text-gray-600">
                                {order?.shipInfo?.address || "Không có địa chỉ"}
                            </p>
                        </div>
                    </div>
                ...
                <div className="bg-white p-4 rounded-lg shadow-md mb-4">
                    <ul className="mb-4 text-sm text-gray-700 space-y-3">
                        {order?.items?.map((item, index) => {
                            ...
                            const lineTotal = (item?.quantity || 0) * unitTotal;
                    ...
                    <div className="text-sm">
                        ...
                        <div className="flex justify-between mb-2">
                            ...
                            <span className="text-gray-800 font-medium">
                                {formatVND(
                                    order?.subtotalPrice ?? computed.subtotal
                                )}
                            </span>
                        </div>
                        <div className="flex justify-between">
                            ...
                            <span className="text-md font-bold text-[#fc6011]">
                                {formatVND(order?.finalTotal ?? computed.final)}
                            </span>
                        </div>
                    </div>
                </div>
          ...
          <button
            ...
            onClick={() => router.push(`/orders/${order._id}/update`)}
          >
            Sửa
          </button>
        </div> */}
