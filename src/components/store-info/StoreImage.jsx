    ...
    <div className='mx-auto max-w-full space-y-6 rounded-xl bg-white p-6 shadow-md'>
      ...
      <div className='flex flex-col md:flex-row items-start md:items-center gap-6'>
        ...
        <div className='w-full md:w-1/5'>
          <label className='block font-bold text-gray-700 mb-2'>Ảnh đại diện</label>
          {previewAvatar && (
            <img src={previewAvatar} alt='Avatar Preview' className='w-32 h-32 object-cover rounded-full border' />
          )}
          {isEditing && (
            <div className='mt-2'>
              <label className='cursor-pointer inline-block rounded bg-orange-500 px-3 py-1 text-white hover:bg-orange-600'>
                Chọn ảnh
        ...
        <div className='w-full md:w-4/5'>
          ...
          {previewCover && (
            <img src={previewCover} alt='Cover Preview' className='w-full h-32 object-cover rounded-lg border' />
          )}
          {isEditing && (
            <div className='mt-2'>
              <label className='cursor-pointer inline-block rounded bg-orange-500 px-3 py-1 text-white hover:bg-orange-600'>
